...
class UfoTools
{
     ...
     * @return string
     */
    public static function сutNice($str, 
                                   $length, 
                                   $offset = 0, 
                                   $removeTags = true)
    {
     ...
     * @return string
     */
    public static function cutMiddle($str, $length, $cutStub = '...')
    {
        $strLength = strlen($str);
     ...
     * @return string|false
     */
    public static function cutBySeparator($str, 
                                          $separator, 
                                          $more = false)
    {
     ...
     * Использует функцию self::cutBySeparator
     *
     * @param string  $str             исходный текст
     * @param string  $separator       разделитель, по которому происходит обрезание
     ...
     * @return string|false
     */
    public static function getTextPartBySeparator($str, 
                                                  $separator, 
                                                  $part = 0, 
                                                  $more = false)
    {
        ...
        //сцепляем нужный и следующий за ним элементы и применяем функцию api_GetCutTextBySeparator
            ...
            return self::cutBySeparator($str, $separator, $more);
        }
    }
     ...
     * @return string|false
     */
    public static function srcFromImg($str)
    {
        $pos = stripos($str, 'src=');
        if (false === $pos) {
            return false;
     ...
     * @return string
     */
    public static function appendDigits($num, $digitsTotal, $left = true)
    {
